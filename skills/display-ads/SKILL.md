...
description: >
 ...
 Variables stored in /home/ubuntu/brain/skills/display-ads/config.json
 category: web
---
...
- **Configuration**: `/home/ubuntu/brain/skills/display-ads/config.json` (agent-editable)
...
**Location**: `/home/ubuntu/brain/skills/display-ads/config.json`
...
edit /home/ubuntu/brain/skills/display-ads/config.json
...
### Agent
Agent only modifies `/home/ubuntu/brain/skills/display-ads/config.json` - never touches the HTML file directly.
...
**Wrong folder:** Config must be at `/home/ubuntu/brain/skills/display-ads/config.json`
...
1. Edit `/home/ubuntu/brain/skills/display-ads/config.json`
